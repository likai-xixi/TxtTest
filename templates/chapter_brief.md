...
- 主角代价或误判：TODO：写本章主角必须付出的代价、误判、判断盲区或不体面选择；没有则说明为什么不能强加。
- 私心 / 逃避 / 迁怒 / 自欺之一：TODO：四选一，写成可入场景的行为，不写成概念。
- 本章不能被写成完美正确的位置：TODO：指出主角、盟友或叙事判断必须保留的不完美处。

## 本章生活毛边

1. TODO：承担人物 / 氛围 / 误导 / 伏笔 / 关系 / 压力 / 讽刺之一；必须是能进正文的具体动作、物件、习惯或环境细节。

## 本章禁止写平

- 不该解释透的情绪：TODO：哪些情绪只留动作、沉默、错位反应或半句话。
- 不该被润色删掉的毛边：TODO：哪些笨拙、尴尬、粗糙、误会或生活噪声必须保留。
