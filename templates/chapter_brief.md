...
TODO：写 S0-S4，并说明本章如何保持主线牵引；低档章要写清功能，高档章要写清后果。

## 外部压力档位

TODO：写 W0-W4，并说明外部世界、制度、势力、资源或关系如何影响本章行动。

## 本章继承变化

TODO：写本章承接上一章或开篇初始状态的具体变化；不能写 none。
...
- 低牵引功能：TODO：若本章低牵引，写消化、蓄压、关系转向、信息校准或转场功能；否则写本章主要功能。
