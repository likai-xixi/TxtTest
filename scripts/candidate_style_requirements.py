...
def render_requirements(chapter: str) -> dict[str, Any]:
    ...
    lines.extend(
        [
            ...
            "",
            "## Human Flavor / Highlight Preservation",
            "",
            "- Preserve the chapter brief's human-flavor focus as a creative constraint, not as exposition.",
            "- The protagonist must have a visible cost, misjudgment, private motive, evasion, resentment, or self-deception when the brief asks for it.",
            "- Keep at least one functional life-texture detail that carries character, pressure, misdirection, relationship, foreshadowing, or irony.",
            "- Do not polish away intentionally rough human observation unless a human editor explicitly asks for that tradeoff.",
            "- Protected highlight IDs from highlights_review require preservation or a human_override_reason in revision planning.",
            "",
