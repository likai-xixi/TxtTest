...
FULL_STEPS = [
    ...
    ("context", "start: derived personality/suspense/world/progression + context pack + quality"),
    ...
    ("reviews", "Codex/DeepSeek reviews + reader experience reviews + model disagreement"),
