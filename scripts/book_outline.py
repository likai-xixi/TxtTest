...
def default_contract(idea_id: str, *, status: str = "CANDIDATE") -> dict[str, Any]:
    ...
    return {
        ...
        "genre_lane": "personal long-form genre fiction",
        ...
        "opening_hook": "A repeatable anomaly creates immediate investigation pressure and chapter-end reasons to continue.",
