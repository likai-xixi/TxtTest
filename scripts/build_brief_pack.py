...
def main() -> int:
    ...
    parts = [
        ...
        "- brief 候选必须使用 schema_version: 2。",
        "- brief 候选必须先写 Story Card，再写 Machine Contract Appendix。",
        "- Story Card 只写创作输入：第一屏扰动、主角欲望、主动动作、阻力、中段变化、小兑现、before -> after、章末点击理由、一条世界规则、禁止临场破局。",
        "- Machine Contract Appendix 写机器治理：连续性、进展、代价、解决边界、reader reward、可用道具/技能 IDs、允许新增元素、最低落账事件。",
        "- 不要把防 AI 味、对白功能、句式破整、细节经济等收章审计长表写进 Story Card。",
        "- 每章必须留下 before -> after 和最低落账事件；低牵引章要说明低牵引功能，高推进章要写代价、后果承接义务、消化窗口和冷却范围。",
        "- 如果本章开场时间、地点或状态不同于上一章章末锚点，必须写清过桥原因和动作。",
        "- 未在 Machine Contract Appendix 中授权的新道具、新技能、新规则，后续不得成为正文破局钥匙。",
        "",
        anchor_text,
